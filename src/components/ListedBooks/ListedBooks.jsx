...
const ListedBooks = () => {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center my-10 w-full  overflow-x-auto overflow-y-hidden sm:justify-center flex-nowrap  text-white">
        <Link
          //   to="/listedbook"
          onClick={() => setTabIndex(0)}
          rel="noopener noreferrer"
          href="#"
          className={`flex items-center flex-shrink-0 px-4 py-3 space-x-2 ${tabIndex === 0 ? "border border-b-0" : "border-b"
        ...
        <Link
          ...
          rel="noopener noreferrer"
          href="#"
          className={`flex items-center flex-shrink-0 flex-auto px-5 py-3 space-x-2 ${tabIndex === 1 ? "border border-b-0" : "border-b"
            } rounded-t-lg border-gray-600 text-gray-900`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
