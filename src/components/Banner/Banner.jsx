...
const Banner = () => {
    return (
        <section className="bg-gray-100 mt-12 rounded-xl dark:text-gray-800">
            ...
            <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                ...
                <div className="flex flex-col justify-center p-4 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                    ...
                    <h1 className="text-5xl work-sans-700 text-black font-bold leading-none sm:text-6xl">Books to freshen  up your bookshelf
                    </h1>
